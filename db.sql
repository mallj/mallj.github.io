...
CREATE TABLE `student` (
  ...
  `st_name` varchar(16) NOT NULL DEFAULT '' COMMENT '学生姓名',
  `st_age` int(20) NOT NULL DEFAULT '0' COMMENT '年龄',
  `st_sex` char(32) NOT NULL DEFAULT '' COMMENT '性别',
  `st_phone` int(10) NOT NULL DEFAULT '0' COMMENT '电话',
  `st_score` int(12) NOT NULL DEFAULT '0' COMMENT '积分'
  PRIMARY KEY (`st_id`)
